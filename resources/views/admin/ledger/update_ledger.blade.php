                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="machine_number" class="form-control valid_control" value="{{$update_ledger->machine_number}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="concrete_hours" class="form-control valid_control" value="{{$update_ledger->concrete_hours}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="bill"  class="form-control valid_control" value="{{$update_ledger->bill}}">
                        </div>
                      </div>
                    </div>
                  </div>
