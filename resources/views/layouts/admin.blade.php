...
<head>
    ...
    <title>
        @yield('title') - Rana zulfiqar & sons
    </title>
...
<script src="{{ asset('admin_assets/plugins/arrive.min.js') }}"></script>
<!--  Google Maps Plugin    -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFAG0STRC3knHuMsk6rs0WNbpqtsfrCJA"></script>
<!-- Chartist JS -->
...
<script src="{{ asset('admin_assets/js/material-dashboard.js?v=2.1.2') }}" type="text/javascript"></script>
